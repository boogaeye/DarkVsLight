package org.faz.dvlmultiload.screen.renderer;
...
public class FluidTankRenderer {
    ...
    private final IFluidTextureHelper fluidTextureHelper;
    ...
    {
        fluidTextureHelper = FactoryManager.fluidTextureHelperFactory.create();
    ...
    @Deprecated(since = "Use fluidTextureHelper.getStillTexture(fluidStack)")
    private TextureAtlasSprite getStillFluidSprite(FluidStack fluidStack)
    {
        return fluidTextureHelper.getStillTexture(fluidStack);
    }

    @Deprecated(since = "Use fluidTextureHelper.getColorTintColor(ingredient)")
    private int getColorTint(FluidStack ingredient)
    {
        return fluidTextureHelper.getColorTintColor(ingredient);
    }
    ...
    public List<Component> getTooltip(FluidStack fluidStack, TooltipFlag tooltipFlag) {
        ...
        try {
            ...
            if (tooltipMode == TooltipMode.SHOW_AMOUNT_AND_CAPACITY) {
                MutableComponent amountString = Component.translatable("darkvslight.tooltip.liquid.amount.with.capacity", nf.format(milliBuckets), nf.format(capacity));
                tooltip.add(amountString.withStyle(ChatFormatting.GRAY));
            } else if (tooltipMode == TooltipMode.SHOW_AMOUNT) {
                MutableComponent amountString = Component.translatable("darkvslight.tooltip.liquid.amount", nf.format(milliBuckets));
                tooltip.add(amountString.withStyle(ChatFormatting.GRAY));
            }
